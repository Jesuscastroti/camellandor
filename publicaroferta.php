...
<!--===============================================================================================-->
	...
	<link rel="stylesheet" type="text/css" href="css2/main.css">
		...
		<title>PUBLICAR OFERTA- <?PHP ECHO $jcnombrecompleto ?></title>
...
?><br><strong>Publica ya tus ofertas</strong>
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form action="registraroferta.php" method="post" class="contact100-form validate-form" enctype="multipart/form-data">
				...
				if ($jclogoempresa==null) {
                    echo"<div>";
                    echo "<input type='file'  value='Logosempresa/predeterminado.jpg' name='txt_logo' readonly/><img src='Logosempresa/predeterminado.jpg' value='Logosempresa/predeterminado.jpg' style='width:150px; height:150px; border-radius: 50%;'></a></img>";
                    echo"</div>";
                    }else{
                    echo"<div  ";
                    echo "<input type='file'  value='$jclogoempresa' name='txt_logo' readonly /><img src='$jclogoempresa'  style='width:150px; height:150px; border-radius: 50%;'></a></img>";
                    echo"</div>";
                      }
			?>		
		...
		<div class="wrap-input100 bg1 rs1-wrap-input100" data-validate="Numero de documento">
			...
			<input class="input100" type="text" value="<?php echo $jcnit ?>"  style="margin-top:25px;font-size:50px;" name="name" readonly>
				...
				<div class="wrap-input100 validate-input bg1" data-validate="Por favor ingresa titulo de oferta">
					<span class="label-input100">Titulo de la oferta *</span>
					<input class="input100" type="text"   name="txt_titulooferta" >
				</div>
                <div class="wrap-input100 validate-input bg0 rs1-alert-validate" data-validate = "Por favor describe su oferta">
					<span class="label-input100">Descripcion de la oferta</span>
					<textarea class="input100" name="txt_descripcion"> </textarea>
				</div>
				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate = "Ingresa salario">
					<span class="label-input100">Salario *</span>
					<input  class="input100" type="number"  name="txt_salario" placeholder="$ 826.812" >
				</div>

				<div class="wrap-input100 bg1 rs1-wrap-input100">
					<span class="label-input100">Tipo de trabajo</span>
					<input class="input100" type="text" name="txt_tipotrabajo"  placeholder="Full time...">
				</div>
				<div class="wrap-input100 input100-select bg1">
					<span class="label-input100">Ciudad de trabajo *</span>
					<div>
