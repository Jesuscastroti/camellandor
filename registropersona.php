...
<div class="container-contact100">
    <div class="wrap-contact100">
        <form action="verificartrabajador.php" method="post" class="contact100-form validate-form" >
            <span class="contact100-form-title">
                Registro de trabajador
            </span>
            <div class="wrap-input100 validate-input bg1" data-validate="Por favor ingresa tu documento">
                <span class="label-input100">Numero documento *</span>
                <input class="input100" type="number" name="txt_documento" placeholder="Ingresa numero documento" required>
            </div>
            <div class="wrap-input100 validate-input bg1" data-validate="Por favor ingresa tu nombre">
                <span class="label-input100">Nombre completo *</span>
                <input class="input100" type="text" name="txt_nombrecompleto" placeholder="Ingresa nombre completo">
            </div>

            <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate = "Ingresa e-mail (ejemplo@gmail.com)">
                <span class="label-input100">Email *</span>
                <input class="input100" type="email" name="txt_email" placeholder="Ingresa e-mail ">
            </div>
